---
id: "text-underline-annotation"
url: "annotation/text-underline-annotation"
title: "Text Underline Annotation"
...
System.out.println("AddTextUnderlineAnnotation: TextUnderline Annotation added: " + result.getTitle());
```
